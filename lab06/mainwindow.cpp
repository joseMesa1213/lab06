    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->graphicsView->scale(.5,.5);//escala
    timer = new QTimer();
...
void MainWindow::on_bntSimular_clicked()
{
    ...
    if(opcion  == 1)
    {
        // (x, y, velx, vely, masa, radio, color)
         Planetas.push_back(new Movimiento('A', 0, 0, 0, 0, 50000, 18));
         scene->addItem(Planetas.back());
         Planetas.push_back(new Movimiento('B', -5000, 0, 0, -2, 70, 10));
         scene->addItem(Planetas.back());
         Planetas.push_back(new Movimiento('C', 5000, 0, 0, 2, 70, 10));
         scene->addItem(Planetas.back());
         Planetas.push_back(new Movimiento('D', 0, -5000, 2, 0, 70, 10));
         scene->addItem(Planetas.back());
         Planetas.push_back(new Movimiento('E', 0, 5000, -2, 0, 70, 10));
         scene->addItem(Planetas.back());
         timer->start(1);
    }
    ...
    {
        // (x, y, velx, vely, masa, radio, color)
        Planetas.push_back(new Movimiento('A', 0, -7000, 2, 0, 70, 11));
        scene->addItem(Planetas.back());
        Planetas.push_back(new Movimiento('B', 0, 0, 0, 0, 70000, 18));
        scene->addItem(Planetas.back());
        Planetas.push_back(new Movimiento('C', 4000, 5000, -1.6, 1.2, 25, 11));
        scene->addItem(Planetas.back());
        timer->start(1);
    }
